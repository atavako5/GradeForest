...
export class TreeBodyComponent implements OnInit {
  ...
  checkAndRefreshData(element: { [x: string]: any }) {
  ...
  cancelEdit(row_data: { [x: string]: any }) {
  ...
  selectRow(row_data: { row_selected: boolean }, event: any) {
  ...
  selectRowOnCheck(row_data: { row_selected: boolean }, event: any) {
